...
assumed to be valid and IO is assumed to succeed (*updated
2014-06-11*: [I have now][errorhandling]). Also, I made no effort to
remove/reduce/streamline allocations.
